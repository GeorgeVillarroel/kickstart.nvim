...
require('lazy').setup({
  ...
  },
  {
    'catppuccin/nvim',
    name = 'catppuccin',
    priority = 1000, -- Ensure this loads before all other plugins
    config = function()
      require('catppuccin').setup {
        ...
        show_end_of_buffer = false, -- Hide the ~ lines at the end of a buffer
        term_colors = true,
        dim_inactive = {
          enabled = false,
          shade = 'dark',
        ...
        integrations = {
          ...
          -- Enable native styles for your main toolchain
          telescope = {
            enabled = true,
            style = 'nvchad', -- Clean, modern layout for telescope floating panels
          },
          neo_tree = true,
          mason = true,
        },
      ...
      -- Set the colorscheme permanently active backend
